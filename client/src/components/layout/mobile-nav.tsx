      ...
      <div className="flex justify-between">
        <button
          ...
          className={`flex flex-col items-center justify-center w-full pt-2 pb-2 ${
            currentLocation === "/" ? "text-primary" : "text-gray-500"
          }`}
        >
          <svg
        ...
        <button
          ...
          className={`flex flex-col items-center justify-center w-full pt-2 pb-2 ${
            currentLocation === "/lists" ? "text-primary" : "text-gray-500"
          }`}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <button
          ...
          className={`flex flex-col items-center justify-center w-full pt-2 pb-2 ${
            currentLocation === "/compare" ? "text-primary" : "text-gray-500"
          }`}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <button
          ...
          className={`flex flex-col items-center justify-center w-full pt-2 pb-2 ${
            currentLocation === "/alerts" ? "text-primary" : "text-gray-500"
          }`}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
